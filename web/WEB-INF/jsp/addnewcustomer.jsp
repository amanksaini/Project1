...
<body>
   ...
   <div class="men">
   	 <div class="container">
   	    <span class="back"> <a class="glyphicon glyphicon-arrow-left" href="addcustomer">BACK</a></span>
	...
	<h1>ADD NEW CUSTOMER</h1>
       <form:form method="post" action="addcdet">  
      	<table >  
         <tr>  
         <td> <span class="glyphicon glyphicon-user"></span>&nbsp;NAME: </td> 
          <td><form:input path="username"/></td><td><form:errors path="username" class="error"/></td>
         </tr> <br> 
         <tr>  
          <td> <span class="glyphicon glyphicon-lock"></span>&nbsp;PASSWORD :</td>  
          <td><form:input path="password" /></td><td><form:errors path="password" class="error"/></td>
         </tr>
         <tr>  
          <td><span class="glyphicon glyphicon-home"></span>&nbsp;ADDRESS:</td>  
          <td><form:input path="address" /></td><td><form:errors path="address" class="error"/></td>
         </tr>
         <tr>  
          <td><span class="glyphicon glyphicon-phone"></span>&nbsp;CONTACT NO. :</td>  
          <td><form:input path="mobileno" /></td><td><form:errors path="mobileno" class="error"/></td>
         </tr>
         <tr>  
          <td><span class="glyphicon glyphicon-envelope"></span>&nbsp;EMAIL:</td>  
          <td><form:input path="email" /></td><td><form:errors path="email" class="error"/></td>
         </tr>
         <tr>  
          <td>GENDER:</td> 
         ...
         <tr>  
          <td><span class="glyphicon glyphicon-hourglass"></span>&nbsp;AGE:</td>  
          <td><form:input path="age" /></td><td><form:errors path="age" class="error"/></td>
         </tr>
         <tr>  
          <td><span class="glyphicon glyphicon-pushpin"></span>&nbsp;PINCODE:</td>  
          <td><form:input path="pincode" /></td><td><form:errors path="pincode" class="error"/></td>
         </tr>
         <tr>  
          <td> 
          </td>
