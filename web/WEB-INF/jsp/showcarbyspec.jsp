...
<body>
   ...
   <div class="men">
	...
	<tr><th>VEHICLE_NO.</th><th>NAME</th><th>PRICE</th><th>AVERAGE</th><th>COLOR</th><th>NO OF CYLINDERS</th><th>ENGINE_TYPE</th><th>CYLINDER_ARRANGEMENT</th><th>ENGINE_PLACEMENT</th><th>ASPIRATIONS</th><th>VALVES</th><th>FUEL_TYPE</th><th>COOLANT</th><th>ENGINE_LAYOUT</th><th>DRIVE_WHEELS</th><th>TRANSMISSION</th><th>MODEL</th><th>CAR PIC</th></tr>
   ...
   <td>${emp.average}</td>
   <td>${emp.color}</td>
   <td>${emp.noofcylinders}</td>
   <td>${emp.enginetype}</td>
   <td>${emp.cylinderarrangement}</td>
      <td>${emp.engineplacement}</td>
   <td>${emp.aspirations}</td>
   <td>${emp.valves}</td>
   <td>${emp.fueltype}</td>
   <td>${emp.coolant}</td>
   <td>${emp.enginelayout}</td>
   <td>${emp.drivewheels}</td>
   <td>${emp.transmission}</td>
   <td>${emp.model}</td>,
   <td> <img src="${emp.img}" height="50" width="50"/></td>
  ...
  <td><a href="BUY/${emp.vehicleno}">BUY</a></td>
