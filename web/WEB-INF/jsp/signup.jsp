	 ...
	 <div class="contact_form">
       ...
       <form:form method="post" action="save" modelAttribute="command">
         ...
         <tr>  
          ...
          <td><form:input type="password" path="password1" /><form:errors path="password1" cssClass="error" /></td>
         ...
         <tr>  
          <td>CONTACT NO. :</td>  
          <td><form:input path="mobileno" /><form:errors path="mobileno" cssClass="error" /></td>
          </tr>
         <tr>  
          <td>E-MAIL:</td>  
        ...
        <td><form:errors path="gender" cssClass="error" /></td>
         ...
         <tr>  
          <td>PINCODE:</td>  
          <td><form:input path="pincode" /><form:errors path="pincode" cssClass="error" /></td>
