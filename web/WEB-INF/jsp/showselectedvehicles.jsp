...
<body>
   ...
   <div class="men">
   	 <div class="container">
             <span class="back"> <a class="glyphicon glyphicon-arrow-left" href="cust">BACK</a></span>
           
      
	 <div class="contact_form">
              
          <h2>SELECTED VEHICLES</h2>
       <form:form method="post" action="showsv" modelAttribute="command">
             <h2>FOR SELECTED CARS</h2>
      	<table align="center">  
         <tr>  
          <td>ENTER YOUR EMAIL ID: </td> 
          <td><form:input path="email"/></td><form:errors path="email" cssClass="error" /></td>
       ...
       <form:form method="post" action="showsb" modelAttribute="command">
           <h2>FOR SELECTED BIKE</h2>
      	<table align="center" >  
         <tr>  
          <td>ENTER YOUR EMAIL ID: </td> 
          <td><form:input path="email"/></td><form:errors path="email" cssClass="error" /></td>
