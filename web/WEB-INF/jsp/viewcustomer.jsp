...
<body>
   ...
   <div class="men">
	...
	<h1>CUSTOMER DETAILS LIST</h1>
        <table class="table table-hover" align="center" border="4" width="100%" cellpadding="3" >
            <tr><th>CUSTOMER ID</th><th>USERNAME</th><th>PASSWORD</th><th>ADDRESS</th><th>MOBILE NO.</th><th>EMAIL</th><th>GENDER</th><th>AGE</th><th>PINCODE</th><th>UPDATE</th><th>DELETE</th></tr>
    <c:forEach var="emp" items="${list}"> 
    <tr>
    <td align="center">${emp.id}</td>
    <td align="center">${emp.username}</td>
    <td align="center">${emp.password}</td>
   <td align="center">${emp.address}</td>
   <td align="center">${emp.mobileno}</td>
   <td align="center">${emp.email}</td>
   <td align="center">${emp.gender}</td>
   <td align="center">${emp.age}</td>
      <td align="center">${emp.pincode}</td>
   
 
      <td align="center"><a href="cusupdate/${emp.id}">UPDATE</a></td>
    <td align="center"><a href="cus_delete/${emp.id}">DELETE</a></td>
    </tr>
    </c:forEach>
    </table>
   
    <span class="center"><h2><a class="glyphicon glyphicon-arrow-left" href="addcustomer">&nbsp;BACK</a></h2></span>
    <br><br>
