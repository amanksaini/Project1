...
<body>
    ...
    <div class="container">
    	<div class="col-md-4 sidebar_men">
    	  ...
    	  <ul class="product-categories color">
              ...
              <c:forEach var="emp" items="${list}"> 
                     <li class="cat-item cat-item-42"><a href="bspecificationsingle1/${emp.makemodel}">${emp.makemodel}</a> </li>
    	  ...
    	  <ul class="product-categories color">
               <c:forEach var="emp" items="${list}"> 
                     <li class="cat-item cat-item-42"><a href="#">${emp.engine}</a> </li>
    	  ...
    	  <ul class="product-categories color">
              ...
              <c:forEach var="emp" items="${list}"> 
              <li class="cat-item cat-item-42"><a href="#">${emp.capacity}</a></li>
    	  ...
    	  <ul class="product-categories">
              ...
              <c:forEach var="emp" items="${list}"> 
              <li class="cat-item cat-item-42"><a href="#"></a> </li>
    	...
    	<div class="col-md-8 model-mar">
    		<div class="dreamcrub">
                ...
                <ul class="previous">
                	<li><a href="cust">Back to Previous Page</a></li>
                </ul>
                <div class="clearfix"></div>
			   </div>
							...
							<a class="cbp-vm-image" href="single">
							 <div class="view view-first">
								 ...
								 <div class="product_image">
                                                                        <div class="mask1"></div><br><br><img src="data:image/jpeg;base64,${emp.img}"  alt="image" class="img-responsive zoom-img"/>
									<div class="mask">
			                       		<div class="info"><a href="bspecificationsingle/${emp.bikeno}">Specifications</a></div>
					                 </div>
					                 <div class="product_container">
                                                             <br><br><br><br>
									   <h4><a href="bspecificationsingle/${emp.bikeno}"></a>${emp.makemodel}</h4>
                                                                           <p><a href="bspecificationsingle/${emp.bikeno}"></a>${emp.engine}</p>
                                                                           
									   <div class="price"><a href="bspecificationsingle/${emp.bikeno}"></a>CAPACITY:${emp.capacity}</div>
									 </div>		
                                                                    </div>
			                     </div>
		                      </div>
   ...
   <div class="footer">
	    ...
	    <div class="clearfix"></div>
	    <div class="copy">
           <p>&copy; 2016 Auto Show.All rights reserved | Design by Amanjit Kaur </p>
	    </div>
   	</div>
   </div>
</body>
