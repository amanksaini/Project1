...
<body>
   ...
   <div class="men">
	...
	<form:form method="post" action="ncmodels">  	
	        
            <h3>PRICE</h3>
            <c:forEach var="emp" items="${list}"> 
        <form:radiobutton path="price" value="${emp.price}"/>${emp.price}<br>
    </c:forEach>
    ...
    <c:forEach var="emp" items="${list}"> 
        <form:radiobutton path="name" value="${emp.name}"/>${emp.name}<br>
    </c:forEach>
      <br>
      <br>
       ...
       <h3>  FUEL TYPE</h3>
     <c:forEach var="emp" items="${list}"> 
        <form:radiobutton path="fueltype" value="${emp.fueltype}"/>${emp.fueltype}<br>
    </c:forEach>
        <br>
            <br>
    <h3> ENGINE TYPE </h3>
     <c:forEach var="emp" items="${list}"> 
        <form:radiobutton path="enginetype" value="${emp.enginetype}"/>${emp.enginetype}<br>
    </c:forEach>
        <br>
            <br>
                ...
                <h3>  TRANSMISSION</h3>
                 ...
                 <c:forEach var="emp" items="${list}"> 
        <form:radiobutton path="transmission" value="${emp.transmission}"/>${emp.transmission}<br>
    </c:forEach>
        <br>
            <br>
