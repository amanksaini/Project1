	...
	<div class="banner">
	     ...
	     <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
	         <ul class="nav navbar-nav">
		        <li class="dropdown">
                    ...
                    <li><div class="col1 nav-float">
							<div class="h_nav">
								<h4>Vehicles</h4>
								<ul>
									<li><a href="#" onclick="message()">car</a></li>
									<li><a href="selectbikespecification">bike</a></li>
		        ...
		        <li><a class="last-nav" href="https://www.google.co.in/search?rlz=1C1CHBF_enUS721US721&biw=1280&bih=615&tbm=nws&ei=PmczWtq0DMjR0gSoxaj4DQ&btnG=Search&q=car+and+bike">News</a></li>
