...
<body>
   ...
   <div class="men">
	...
	<tr> <th>BIKE_NO.</th><th>MAKE_MODEL</th><th>IMAGE</th><th>BIKE SPECIFICATIONS</th></tr>
    <c:forEach var="emp" items="${list}"> 
    <tr>
    <td align="center">${emp.bikeno}</td>
    <td align="center">${emp.makemodel}</td>
             <td align="center"><img src="data:image/jpeg;base64,${emp.img}" alt="..." width="200" height="200"></td>
    
   
<td><a href="bspecificationselect/${emp.bikeno}">SPECIFICATION</a></td>
