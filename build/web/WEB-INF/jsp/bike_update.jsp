...
<body>
   ...
   <div class="men">
	 ...
	 <div class="contact_form">
	  	...
	  	<h1>UPDATE BIKE</h1>
       <form:form method="post" action="/vehdeal/updatebikedet">  
      	 
           <table>
               <tr>
      	<td></td>  
         <td><form:hidden  path="bikeno" /></td>
         </tr> 
         <tr>  
          <td>MAKE_MODEL : </td> 
          <td><form:input path="makemodel"  /></td>
         </tr>
           <tr>  
          <td>YEAR : </td> 
          ...
          <td>BORE x STROKE : </td> 
          <td><form:input path="borexstroke"  /></td>
         </tr>
         
         <tr>  
          <td>COOLING_SYSTEM : </td> 
          <td><form:input path="coolingsystem"  /></td>
         </tr>
         <tr>  
          <td>COMPRESSION RATIO : </td> 
          <td><form:input path="compressionratio"  /></td>
         </tr>
         <tr>  
          <td>LUBRICATION : </td> 
          <td><form:input path="lubrication"  /></td>
         </tr>
         <tr>  
          <td>INDUCTION : </td> 
          <td><form:input path="induction"  /></td>
         </tr>
         
         <tr>  
          <td>IGNITION : </td> 
          <td><form:input path="ignition"  /></td>
         </tr>
         
         <tr>  
          <td>STARTING : </td> 
          <td><form:input path="vstarting"  /></td>
         </tr>
         
        <tr>  
          <td>MAX POWER : </td> 
          <td><form:input path="maxpower"  /></td>
         </tr>
         
         <tr>  
          <td>MAX TORQUE: </td> 
          <td><form:input path="maxtorque"  /></td>
         </tr>
         <tr>  
          <td>CLUTCH : </td> 
          <td><form:input path="clutch"  /></td>
         </tr>
         <tr>  
          <td>TRANSMISSION : </td> 
         ...
         <tr>  
          <td>FINAL DRIVE : </td> 
          <td><form:input path="finaldrive"  /></td>
         </tr>
         <tr>  
          <td>FRAME : </td> 
         ...
         <tr>  
          ...
          <td><form:input path="frontsuspension"  /></td>
         </tr>
         <tr>  
          <td>FRONT WHEEL TRAVEL : </td> 
          <td><form:input path="frontwheeltravel"  /></td>
         </tr>
         <tr>  
          <td>FRONT BRAKES: </td> 
          <td><form:input path="frontbrakes"  /></td>
         </tr>
         <tr>  
          <td>REAR BRAKES: </td> 
          <td><form:input path="rearbrakes"  /></td>
         </tr>
         <tr>  
          <td>FRONT TYRE : </td> 
          <td><form:input path="fronttyre"  /></td>
         </tr>
         <tr>  
          <td>REAR TYRE: </td> 
          <td><form:input path="reartyre"  /></td>
         </tr>
         <tr>  
          <td>STEERING ANGLE: </td> 
          <td><form:input path="steering"  /></td>
         </tr>
         <tr>  
          <td>WHEELBASE: </td> 
          <td><form:input path="wheelbase"  /></td>
         </tr>
         <tr>  
          <td>GROUND CLEARANCE : </td> 
          <td><form:input path="groundclearance"  /></td>
         </tr>
         <tr>  
          <td>SEAT HEIGHT: </td> 
          <td><form:input path="seatheight"  /></td>
         </tr>
         <tr>  
          <td>DRY WEIGHT : </td> 
          <td><form:input path="dryweight"  /></td>
         </tr>
         <tr>  
          <td>FUEL CAPACITY: </td> 
