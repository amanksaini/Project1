...
<body>
   ...
   <div class="men">
	 ...
	 <div class="contact_form">
		...
		<h1>Sell Car</h1>
       <form:form method="post" action="sell-car" modelAttribute="command">
      	...
      	<table>  
           <tr>  
             	...
             	<form:input type="text" path="carid" class="text"  placeholder="Enter carid" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter carid';}"/><form:errors path="carid" cssClass="error" />
          
         </tr>
         <tr>  
          
          	<form:input type="text" path="username" class="text"  placeholder="Enter name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Name';}"/><form:errors path="username" cssClass="error"/>
			
         </tr>  
         <tr>  
      
             	<form:input type="text" path="email" class="text"  placeholder="Enter email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}"/><form:errors path="email" cssClass="error" />
          
         </tr>
         <tr>  
           
             	<form:input type="text" path="mobileno" class="text"  placeholder="phone no" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Mobile';}"/><form:errors path="mobileno" cssClass="error" />
          </tr>
         <tr>  
         
          	<form:input type="text" path="city" class="text" placeholder="City" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'City';}"/><form:errors path="city" cssClass="error" />
          </tr>
