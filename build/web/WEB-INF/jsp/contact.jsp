...
<body>
   ...
   <div class="men">
      ...
      <div class="grid_2 preffix_1">
	      <ul class="iphone">
	      	<i class="phone"> </i>
	      	<li class="phone_desc">Phone : 8284854211</li>
	      	<div class="clearfix"> </div>
	     </ul>
	  ...
	  <div class="grid_3">
	      <ul class="iphone">
	      	<i class="msg"> </i>
	        <li class="phone_desc">Email : <a href="malito:mail@demolink.com">amanjitsaini11@gmail.com</a> </li>
	      	<div class="clearfix"> </div>
	      </ul>
	      <ul class="iphone">
	      	<i class="home"> </i>
	        <li class="phone_desc">Address : Vill.Gobindpur P.O.Jhallian Kalan Distt.Ropar </li>
	      	<div class="clearfix"> </div>
	      </ul>
	  </div>
	  <div class="clearfix"> </div>
	 ...
	 <div class="contact_form">
	    ...
	    <form:form method="post" action="contact-post">
					<div class="col-md-6 to">
                     	<form:input type="text" path="username" class="text"  value="Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}"/>
					 	<form:input type="text" path="email" class="text" value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}"/>
					 	<form:input type="text"  path="subject" class="text" value="Subject" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Subject';}"/>
					</div>
					<div class="col-md-6 text">
                                            <form:textarea type="text" placeholder="Message" value="Message" path="message" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message';}"/>
	                </div>
	                <div class="clearfix"></div>
	                <div class="but__center"><input type="submit" value="Send message &gt;&gt;"></div>
            </form:form> <div class="contact_form">
	 	<h2>Feedback</h2>
