...
<body>
   ...
   <div class="men">
	...
	<table border="2" width="70%" cellpadding="2">
            ...
            <tr><th>VEHICLE NO</th><th>NAME</th><th>IMAGE</th><th>SPECIFICATION</th></tr>
    <c:forEach var="emp" items="${list}"> 
    <tr>
    <td align="center">${emp.vehicleno}</td>
    <td align="center">${emp.name}</td>
    

    <td align="center"><img src="data:image/jpeg;base64,${emp.img}" alt="..." width="200" height="200"></td>
    
  <td><a href="buycarspecification/${emp.vehicleno}">SPECIFICATIONS</a></td>
   ...
   <div class="footer">
   	 <div class="container">
   		<div class="cssmenu">
				<ul>
					<li class="active"><a href="privacys">Privacy</a></li>
