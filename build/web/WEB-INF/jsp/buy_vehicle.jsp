...
<table border="4" width="60%" cellpadding="2" align="center">
    <tr><th>NAME</th><th>EMAIL</th><th>MOBILENO</th><th>CITY</th><th>MANUFACTURER</th><th>DATE</th><th>FUELTYPE</th><th>DISTANCECOVERED</th><th>OWNER</th><th>PRICE</th><th>IMAGE</th></tr>
        ...
        <tr>
            ...
            <td>${emp.date}</td>
            <td>${emp.fueltype}</td>
            <td>${emp.distancecovered}</td>
            <td>${emp.owner}</td>
            <td>${emp.price}</td>
             <td><img src="data:image/jpeg;base64,${emp.img}" alt="..." width="200" height="200"></td>
             ...
             <br><br><h3 align="center">FOR FURTHER DETAILS CONTACT WITH SPECIFIED OWNER </h3>
<br/>
